...
var obstacle : Array = [
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock1.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock2.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock3.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock4.png")
]
	
var obstacle_destroy : Array = [
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock1_destroy.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock2_destroy.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock3_destroy.png"),
	ResourceLoader.load("res://Assets/Sprites/Obstacle/Rock4_destroy.png")
]
...
func check_destroy()->void:
	if hpObstacle == 0 :
		...
		$Obstacle.texture = _visual_destroy
		Global.battle.tile_data[pos_in_map] = null
		Global.battle.map.astar.set_Unsolid(pos_in_map)
